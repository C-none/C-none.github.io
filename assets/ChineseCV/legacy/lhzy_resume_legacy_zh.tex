...
\vspace{12pt}
\section{职业经历}
\datedsubsection{\textbf{网易互娱，荒野事业部，图形开发实习}}{2026.5-2026.8}
\begin{itemize}
  \item 完善光追组件，构建Path tracer做为引擎的标准光照能量参考，添加对自发光光源的采样支持。
  \item 拓展GPU Lightmass功能，支持World Composition场景中的分区烘焙。
\end{itemize}
...
\begin{itemize}[parsep=0.2ex]
  ...
  \item \textbf{工具框架}: Vulkan, WebGPU, UE, Three.js, Blender, Unity
